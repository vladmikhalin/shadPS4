...
/// @brief Resource manager for indexed resources based on Interval Set
/// @tparam Index Type of index
/// @tparam T Type of resource
/// @tparam MaxIndex Maximum value of index
...
public:
    ...
    /// @brief Attempt to create new resource in the set
    /// @tparam ...Types types of arguments forwarded to the constructor of T
    /// @param ...args arguments forwarded to the constructor of T
    /// @return `nullopt` if failed or index if successful
